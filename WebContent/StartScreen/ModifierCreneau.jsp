...
<body>
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
				...
				<ul class="children collapse" id="sub-item-3">
					...
					<li><a class="" href="#">
						<span class="fa fa-arrow-right">&nbsp;</span> Créneau libre
					</a></li>
				</ul>
			</li>
			<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Modifier un créneau</h1>
			</div>
		</div><!--/.row-->
		...
		<section class="contact-wrap">
			...
			<table class="container">
				...
				<thead>
					<tr>
					<th><h1>Numéro créneau</h1></th>
					<th><h1>Heure Début</h1></th>
					<th><h1>Heure Fin</h1></th>
					</tr>
				</thead>
				<%
				...
				<tbody>
				<tr>
				<td><%= AllCreneau.get(i).getId()%></td>
				<td><%= AllCreneau.get(i).getHeureDebut()%></td>
				<td><%= AllCreneau.get(i).getHeureFin()%></td>
				</tr>
			...
			<form name="modifiercreneau" id="modifiercreneau">
			<table>
				<tr>
				<td><label>Heure début</label></td>
				<td><input type="time" id="heuredebut" /></td>
				</tr>
				<tr>
				<td><label>Heure fin</label></td>
				<td><input type="time" id="heurefin" /></td>
				</tr>
				<tr>
				<td><input type="hidden" id="idCreneau" /></td>
				</tr>
				<tr>
				<td><input type="submit" value="Confirmer" id="confirmechange" /></td>
				</tr>
			</table>
			</form>
	...
	<script src="js/modifierCreneau.js"></script>
	<script type="js/confirmeChange.js"></script>
	<script>
