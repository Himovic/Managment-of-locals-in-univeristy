<%@page import="Functions.ReservationFunction"%>
...
<head>
	...
	<title>Libérer Réservation</title>
	...
	ArrayList<Reservation> allReservations = (ArrayList<Reservation>)ReservationFunction.allReservations();
	%>
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Libérer Réservation</h1>
			</div>
		</div><!--/.row-->
		...
		<section class="contact-wrap">
			...
			<table class="container">
				...
				<thead>
					<tr>
					<th><h1>Numéro Réservation</h1></th>
				...
				<tbody>
				<tr>
				<td><%= allReservations.get(i).getIdReservation()%></td>
				<td><%= allReservations.get(i).getLocal().getNom()%></td>
				<td><%= allReservations.get(i).getDate()%></td>
				<td><%= allReservations.get(i).getCreneau().getHeureDebut() +"-"+allReservations.get(i).getCreneau().getHeureFin()%></td>
				</tr>
	...
	<script src="js/LibererReservation.js"></script>
	<script>
