...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ajouter un créneau</h1>
			</div>
		</div><!--/.row-->
		
		<section class="contact-wrap">
		<form class="contact-form">
    	<input type="hidden" name="hiddenajoutequip" value="hiddenajoutequip"/>
    	<div class="col-sm-12">
      	<div class="input-block">
      	<table>
      		<tr>
      			<td><label for="">Heure Début</label></td>
      			<td><input type="time" id ="heuredebut" name="heuredebut" placeholder="Début de l'heure" class="form-control" required/></td>
      		</tr>
      		<tr>
      			<td><label for="">Heure Fin</label></td>
      			<td><input type="time" id ="heurefin" name="heurefin" placeholder="Fin de l'heure" class="form-control" required/></td>
      		</tr>
      		<tr>
      		<td><div class="col-sm-12">
      <input type="submit" id="submit" value="Ajouter Créneau"  class="btn btn-primary btn-lg btn-block"/>
    </div></td></tr>
	...
	<script src="js/AjouterCreneau.js"></script>
	<script>
