...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ajouter un équipement</h1>
			</div>
		</div><!--/.row-->
        ...
        <label for="">Nom équipement</label>
        <input type="text" id ="nomequipement" name="nomequipement" placeholder="nom de l'équipement" class="form-control" required/>
      </div>
    	</div><br /><br />
    <div class="col-sm-12">
      <input type="submit" id="submit" value="Ajouter Equipement"  class="btn btn-primary btn-lg btn-block"/>
    </div>
  </form>
</section>
	...
	<script src="js/AjouterEquipement.js"></script>
	<script>
